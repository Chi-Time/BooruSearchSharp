...
namespace BooruSearchSharp.FurryBooru
{
    public class FurryBooru
    {
        ...
        {
            string url = "http://furry.booru.org/index.php?page=dapi&s=post&q=index&{0}{1}";
            string api = "tags=";
