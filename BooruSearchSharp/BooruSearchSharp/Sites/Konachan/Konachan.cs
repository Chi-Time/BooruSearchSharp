...
namespace BooruSearchSharp.Konachan
{
    public class Konachan
    {
        ...
        void Start ()
        {
            ...
            List<KCImageInfo> imLst = JsonConvert.DeserializeObject<List<KCImageInfo>> (objectData);
