...
namespace BooruSearchSharp.Safebooru
{
    public class SafeBooru
    {
        public SafeBooru ()
        {
            Start ();
        ...
        {
            string url = "http://safebooru.org/index.php?page=dapi&s=post&q=index&{0}{1}";
            string api = "tags=";
